...
import ActorList from '@/components/screens/admin/actorList/ActorList';
import GenreEdit from '@/components/screens/admin/genre/GenreEdit';
import GenreList from '@/components/screens/admin/genreList/GenreList';
import Admin from '@/components/screens/admin/home/Admin';
import MovieEdit from '@/components/screens/admin/movie/MovieEdit';
import MovieList from '@/components/screens/admin/movieList/MovieList';
import UserEdit from '@/components/screens/admin/user/UserEdit';
import UserList from '@/components/screens/admin/userList/UserList';
...
export const adminRoutes: IRoute[] = [
  ...
  { name: 'ActorList', component: ActorList, isAdmin: true },
  { name: 'GenreEdit', component: GenreEdit, isAdmin: true },
  { name: 'GenreList', component: GenreList, isAdmin: true },
  { name: 'MovieEdit', component: MovieEdit, isAdmin: true },
  { name: 'MovieList', component: MovieList, isAdmin: true },
  { name: 'UserEdit', component: UserEdit, isAdmin: true },
  { name: 'UserList', component: UserList, isAdmin: true },
];
